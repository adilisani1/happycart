...
const Products = () => {
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 md:gap-8 gap-5 max-w-screen-2xl rounded-xl px-5 pb-7 pt-5 sm:px-20 mx-auto relative mb-20">
                ...
                rounded-2xl relative  mb-14 justify-between cursor-pointer">
                        <div className="flex items-center justify-center pt-6">
                            <img className=" md:max-w-[340px] -mt-24 object-cover max-w-48"
                        ...
                        <div className=' flex items-center justify-center text-center flex-col mx-auto pt-4 pb-10'>
                            <h3 className='md:text-[17px] text-sm mb-1'>{product.title}</h3>
